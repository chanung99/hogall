...
public class ProductVo {
	...
	public ProductVo(int productId, String productCategory, String productName, String buyNowPrice,
			...
			String price, String unit, String views) {
		super();
	...
	public String toString() {
		return "ProductVo [productId=" + productId + ", productCategory=" + productCategory + ", productName="
				...
				+ commition + ", price=" + price + ", unit=" + unit + ", views=" + views + "]";
	}
