...
.loginBtn{
	...
	position: relative;
	top: 28px;
	/* background-image: url(${path}/resources/images/close.png) */
}
...
<body>
	...
	<header id="main-header"> 
		<div class="banner_container">
			<div class="gallBanner_info">
				<p class="banner_infoText">본 사이트는 상업적 목적이 아닌 개인 포트폴리오 용도로 제작되었습니다.</p>
				<a href="#" class="info_close"></a>
			</div> 
		</div>	
			...
			<div class="navboxWrap">
				...
				<c:if test="${loggedMember==null }">
                        ...
                        <form class="login_form" name="loginForm"
                           action="${pageContext.request.contextPath }/member/login.do" method="post" onsubmit="return loginFnc()">
                           ...
                           <div class="login_set fl">
                             ...
                             <input type="hidden" id="pathurl" name="pathurl" value=""/>
                           </div>
                        </form>
					...
					<c:if test="${loggedMember!=null }">
								...
								<div class="user_name">
									<a href="#" style="color: #ffffff;">${loggedMember.name }</a>님 |
								</div>
				...
				<nav class="main-nav">
					...
					<div class="dropdown">
					 ...
					 <ul class="top_menu">
						...
						<li><a href="#">공지사항</a></li>
						<li><a href="#">이벤트</a></li>
						<li><a href="${path }/member/myPage?id=${loggedMember.memberId }">마이페이지</a></li>
						<li><a href="#"></a></li>
					</ul>
					<div id="search-bar">
	...
	$(function(){
		...
		var spl = thisfilefoldername.split('/gall');
	...
	function loginFnc(e){
		...
		var spl = link.split('7080/gall');/* 주의!!!! 나중에 shop/gall로 수정할것 */
		$("#pathurl").val(spl[1]);
	...
	function logout(){
		...
		location.href="${pageContext.request.contextPath}/member/logout.do?pathurl="+spl[1]; 
